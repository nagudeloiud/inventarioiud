...
const { createTipoEquipo, getTiposEquipoById, getTiposEquipo, getTiposEquipoUserActivo, updateTipoEquipoById, deleteTipoEquipoById } = require('../controllers/tipoEquipo');
